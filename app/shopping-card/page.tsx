    ...
    <>
      <div style={{ display: "flex", gap: "20px", padding: "20px" }} className="container flex flex-cols items-center justify-center">
        ...
        <div>
          ...
          <h3 className="text-3xl pb-[120px] font-bold ">Cart Totals</h3>
 
          <p>Coupon Apply</p>
          <div style={{ marginBottom: "10px" }} className="border-2 border-green-400 w-auto rounded-lg">
            <input
              type="text"
              placeholder="Enter coupon code here..."
              style={{ outline:"none", padding: "5px", width: "60%" }}
            />
            <button style={{ padding: "5px", marginLeft: "57px", width:"70px"}} className="bg-green-500 hover:bg-green-500">Apply</button>
          </div>
